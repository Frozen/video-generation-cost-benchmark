...
def payload_from(original):
    ...
    return {"model": "MiniMaxAI/MiniMax-H3", "prompt": original + "\n\n" + ENGLISH,
            ...
            "num_inference_steps": 50, "flow_shift": 12.0, "audio_flow_shift": 3.0, "seed": 42}
...
def main():
    ...
    if lease.get("generation_submissions") != 0:
    ...
    try:
        ...
        lease["generation_submissions"] = 1
